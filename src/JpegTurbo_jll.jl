...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import JpegTurbo_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("aacddb02-875f-59d6-b918-886e6ef4fbf8"))
...
if best_platform === nothing
    @debug("Unable to load JpegTurbo; unsupported platform $(triplet(platform_key_abi()))")
else
